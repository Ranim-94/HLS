...
HLS_SOURCES = ../../../../leading_one_tb.cpp ../../../../main_leading_one.cpp
...
$(ObjDir)/leading_one_tb.o: ../../../../leading_one_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../leading_one_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/leading_one_tb.d

$(ObjDir)/main_leading_one.o: ../../../../main_leading_one.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_leading_one.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_leading_one.d
