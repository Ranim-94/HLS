...
if {[file isfile leading_one.autotvin.dat]} {
	file delete -force leading_one.autotvin.dat
}

if {[file isfile leading_one.autotvout.dat]} {
	file delete -force leading_one.autotvout.dat
}
