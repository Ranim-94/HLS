...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "leading_one.autotvin.dat"
	set constFileTvOut       "leading_one.autotvout.dat"
	set constFileHdlTvIn     "leading_one.autohdltvin.dat"
	set constFileHdlTvOut    "leading_one.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
