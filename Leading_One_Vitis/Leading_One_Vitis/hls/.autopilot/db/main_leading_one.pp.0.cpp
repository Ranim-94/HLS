...
# 9 "./leading_one.hpp" 2
# 5 "main_leading_one.cpp" 2

__attribute__((sdx_kernel("leading_one", 0))) ap_int<5> leading_one(ap_uint<9> a) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=leading_one
# 6 "main_leading_one.cpp"
