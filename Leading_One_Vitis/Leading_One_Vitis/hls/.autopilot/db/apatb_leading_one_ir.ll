; ModuleID = '/home/lenovo/Simulation_Linux/HLS/Leading_One_Vitis/Leading_One_Vitis/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
declare void @apatb_leading_one_hw(%"struct.ap_int<5>"*, %"struct.ap_uint<9>"*)
...
declare void @leading_one_hw_stub(%"struct.ap_int<5>"*, %"struct.ap_uint<9>"* nocapture readonly)

define void @leading_one_hw_stub_wrapper(%"struct.ap_int<5>"*, %"struct.ap_uint<9>"*) #2 {
entry:
  call void @copy_out()
  call void @leading_one_hw_stub(%"struct.ap_int<5>"* %0, %"struct.ap_uint<9>"* %1)
  call void @copy_in()
  ret void
}

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_leading_one_ir(%"struct.ap_int<5>"* %ret, %"struct.ap_uint<9>"* nocapture readonly %a) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %"struct.ap_int<5>"
  call void @apatb_leading_one_hw(%"struct.ap_int<5>"* %0, %"struct.ap_uint<9>"* %a)
  call void @copy_back()
  %1 = load volatile %"struct.ap_int<5>", %"struct.ap_int<5>"* %0
  store %"struct.ap_int<5>" %1, %"struct.ap_int<5>"* %ret
  ret void
}
