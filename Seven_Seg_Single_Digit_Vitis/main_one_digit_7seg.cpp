...
#include"one_digit_7seg.hpp"

void single_seven_segment(ap_uint<8> digit, ap_uint<8> *code7segment, ap_uint<4> *control_signals) {
...
#pragma HLS INTERFACE ap_ctrl_none port=return
    ...
    // Enabling the last 7 seg 
	*control_signals = 0b1110;


} /* End single_seven_segment()  */