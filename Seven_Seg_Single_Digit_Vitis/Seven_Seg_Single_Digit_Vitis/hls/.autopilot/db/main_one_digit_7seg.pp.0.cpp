...
# 2 "<built-in>" 2
# 1 "main_one_digit_7seg.cpp" 2



# 1 "./one_digit_7seg.hpp" 1
...
# 6 "./one_digit_7seg.hpp" 2
# 5 "main_one_digit_7seg.cpp" 2

__attribute__((sdx_kernel("single_seven_segment", 0))) void single_seven_segment(ap_uint<8> digit, ap_uint<8> *code7segment, ap_uint<4> *control_signals) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=single_seven_segment
# 6 "main_one_digit_7seg.cpp"
