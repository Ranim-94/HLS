...
const int W=16;
# 4 "main_parity_bit.cpp" 2


__attribute__((sdx_kernel("parity_generator", 0))) bool parity_generator(ap_uint<W> a) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=parity_generator
# 6 "main_parity_bit.cpp"
...
#pragma HLS INTERFACE ap_ctrl_none port=return
 ...
 VITIS_LOOP_16_1: for (int i = 0; i < W; i++) {
