...
HLS_SOURCES = ../../../../parity_bit_tb.cpp ../../../../main_parity_bit.cpp
...
$(ObjDir)/parity_bit_tb.o: ../../../../parity_bit_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../parity_bit_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/parity_bit_tb.d

$(ObjDir)/main_parity_bit.o: ../../../../main_parity_bit.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_parity_bit.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_parity_bit.d
