...
# 2 "<built-in>" 2
# 1 "home_alarm_sys.cpp" 2


# 1 "./home_alarm_sys.hpp" 1
...
void display_motion(
  ...
  ap_uint<8> *sg_data,
  ap_uint<4> *sg_enable);
# 4 "home_alarm_sys.cpp" 2
# 29 "home_alarm_sys.cpp"
void display_window(
  ap_uint<3> window_sensors,
  ap_uint<5> show_fault,
...
# 44 "home_alarm_sys.cpp"
 *sg_data = svn_sg_code[14];
 *sg_enable = 0b0000;
