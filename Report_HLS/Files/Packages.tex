...
\usepackage[
	colorlinks=true
	,breaklinks
	]{hyperref} % needed for creating hyperlinks in the document 
	
% - the option colorlinks=true gets rid of the awful boxes 
% - breaklinks breaks lonkg links (list of figures),
...
\usepackage{fancyhdr} % To adjust the page style
...
\usepackage{todonotes} % needed for todos liste
