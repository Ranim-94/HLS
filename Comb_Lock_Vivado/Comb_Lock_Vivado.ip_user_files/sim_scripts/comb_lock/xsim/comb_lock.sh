...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot comb_lock xil_defaultlib.comb_lock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim comb_lock -key {Behavioral:sim_1:Functional:comb_lock} -tclbatch cmd.tcl -protoinst "protoinst_files/comb_lock.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb comb_lock.wdb xsim.dir libdpi.so)
