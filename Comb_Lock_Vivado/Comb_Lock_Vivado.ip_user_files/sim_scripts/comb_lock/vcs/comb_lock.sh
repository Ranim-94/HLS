...
#
# Script generated by Vivado on Fri May 08 12:26:35 CEST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : comb_lock.sh
...
#
# Usage        : comb_lock.sh
#                comb_lock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                comb_lock.sh [-reset_run]
#                comb_lock.sh [-reset_log]
#                comb_lock.sh [-help]
#
...
#                script (type 'comb_lock.sh -help' for more information).
#
...
# script info
echo -e "comb_lock.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./comb_lock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.comb_lock xil_defaultlib.glbl -o comb_lock_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./comb_lock_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lenovo/Simulation_Linux/HLS/Comb_Lock_Vivado/Comb_Lock_Vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key comb_lock_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc comb_lock_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./comb_lock.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: comb_lock.sh [-help]\n\
Usage: comb_lock.sh [-step]\n\
Usage: comb_lock.sh [-lib_map_path]\n\
Usage: comb_lock.sh [-reset_run]\n\
Usage: comb_lock.sh [-reset_log]\n\
Usage: comb_lock.sh [-keep_index]\n\
Usage: comb_lock.sh [-noclean_files]\n\n\
