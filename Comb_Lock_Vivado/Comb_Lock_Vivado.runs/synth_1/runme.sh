...
HD_PWD='/home/lenovo/Simulation_Linux/HLS/Comb_Lock_Vivado/Comb_Lock_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_lock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_lock_wrapper.tcl
