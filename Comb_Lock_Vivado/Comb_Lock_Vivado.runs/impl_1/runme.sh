...
HD_PWD='/home/lenovo/Simulation_Linux/HLS/Comb_Lock_Vivado/Comb_Lock_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_lock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_lock_wrapper.tcl -notrace
