; ModuleID = '/home/lenovo/Simulation_Linux/HLS/LED_Controller_Vitis/LED_Controller_Vitis/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_led_ON_ir(i8* noalias nocapture nonnull %o) local_unnamed_addr #0 {
entry:
  %o_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %o, i8* nonnull align 512 %o_copy)
  call void @apatb_led_ON_hw(i8* %o_copy)
...
declare void @apatb_led_ON_hw(i8*)
...
declare void @led_ON_hw_stub(i8* noalias nocapture nonnull)

define void @led_ON_hw_stub_wrapper(i8*) #4 {
entry:
  call void @copy_out(i8* null, i8* %0)
  call void @led_ON_hw_stub(i8* %0)
