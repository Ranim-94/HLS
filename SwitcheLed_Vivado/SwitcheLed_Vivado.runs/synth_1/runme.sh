...
HD_PWD='/home/lenovo/Simulation_Linux/HLS/SwitcheLed_Vivado/SwitcheLed_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switche_LED_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switche_LED_wrapper.tcl
