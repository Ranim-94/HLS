...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot switche_LED xil_defaultlib.switche_LED xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim switche_LED -key {Behavioral:sim_1:Functional:switche_LED} -tclbatch cmd.tcl -protoinst "protoinst_files/switche_LED.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb switche_LED.wdb xsim.dir libdpi.so)
