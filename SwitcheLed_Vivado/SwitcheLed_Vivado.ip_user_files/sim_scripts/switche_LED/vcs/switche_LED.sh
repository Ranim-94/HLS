...
#
# Script generated by Vivado on Tue Oct 07 13:26:45 CEST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : switche_LED.sh
...
#
# Usage        : switche_LED.sh
#                switche_LED.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                switche_LED.sh [-reset_run]
#                switche_LED.sh [-reset_log]
#                switche_LED.sh [-help]
#
...
#                script (type 'switche_LED.sh -help' for more information).
#
...
# script info
echo -e "switche_LED.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./switche_LED.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.switche_LED xil_defaultlib.glbl -o switche_LED_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./switche_LED_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key switche_LED_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc switche_LED_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./switche_LED.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: switche_LED.sh [-help]\n\
Usage: switche_LED.sh [-step]\n\
Usage: switche_LED.sh [-lib_map_path]\n\
Usage: switche_LED.sh [-reset_run]\n\
Usage: switche_LED.sh [-reset_log]\n\
Usage: switche_LED.sh [-keep_index]\n\
Usage: switche_LED.sh [-noclean_files]\n\n\
