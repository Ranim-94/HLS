...
#
# Script generated by Vivado on Mon Mar 02 08:41:26 CET 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : paralle_serial_sys.sh
...
#
# Usage        : paralle_serial_sys.sh
#                paralle_serial_sys.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                paralle_serial_sys.sh [-reset_run]
#                paralle_serial_sys.sh [-reset_log]
#                paralle_serial_sys.sh [-help]
#
...
#                script (type 'paralle_serial_sys.sh -help' for more information).
#
...
# script info
echo -e "paralle_serial_sys.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./paralle_serial_sys.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.paralle_serial_sys xil_defaultlib.glbl -o paralle_serial_sys_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./paralle_serial_sys_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key paralle_serial_sys_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc paralle_serial_sys_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./paralle_serial_sys.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: paralle_serial_sys.sh [-help]\n\
Usage: paralle_serial_sys.sh [-step]\n\
Usage: paralle_serial_sys.sh [-lib_map_path]\n\
Usage: paralle_serial_sys.sh [-reset_run]\n\
Usage: paralle_serial_sys.sh [-reset_log]\n\
Usage: paralle_serial_sys.sh [-keep_index]\n\
Usage: paralle_serial_sys.sh [-noclean_files]\n\n\
