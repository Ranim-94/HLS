...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot paralle_serial_sys xil_defaultlib.paralle_serial_sys xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim paralle_serial_sys -key {Behavioral:sim_1:Functional:paralle_serial_sys} -tclbatch cmd.tcl -protoinst "protoinst_files/paralle_serial_sys.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb paralle_serial_sys.wdb xsim.dir libdpi.so)
