...
--               /home/lenovo/Simulation_Linux/HLS/Parallel_Serial_Sys_Vivado/Parallel_Serial_Sys_Vivado.gen/sources_1/bd/paralle_serial_sys/ip/paralle_serial_sys_parallel2serial_0_0/paralle_serial_sys_parallel2serial_0_0_sim_netlist.vhdl
...
entity paralle_serial_sys_parallel2serial_0_0_parallel2serial is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of paralle_serial_sys_parallel2serial_0_0_parallel2serial : entity is "parallel2serial";
  attribute ap_ST_fsm_state1 : string;
  attribute ap_ST_fsm_state1 of paralle_serial_sys_parallel2serial_0_0_parallel2serial : entity is "1'b1";
  attribute hls_module : string;
  attribute hls_module of paralle_serial_sys_parallel2serial_0_0_parallel2serial : entity is "yes";
end paralle_serial_sys_parallel2serial_0_0_parallel2serial;

architecture STRUCTURE of paralle_serial_sys_parallel2serial_0_0_parallel2serial is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity paralle_serial_sys_parallel2serial_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
    a : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute NotValidForBitStream of paralle_serial_sys_parallel2serial_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of paralle_serial_sys_parallel2serial_0_0 : entity is "paralle_serial_sys_parallel2serial_0_0,parallel2serial,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of paralle_serial_sys_parallel2serial_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of paralle_serial_sys_parallel2serial_0_0 : entity is "HLS";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of paralle_serial_sys_parallel2serial_0_0 : entity is "parallel2serial,Vivado 2025.1";
  attribute hls_module : string;
  attribute hls_module of paralle_serial_sys_parallel2serial_0_0 : entity is "yes";
end paralle_serial_sys_parallel2serial_0_0;

architecture STRUCTURE of paralle_serial_sys_parallel2serial_0_0 is
...
begin
inst: entity work.paralle_serial_sys_parallel2serial_0_0_parallel2serial
     port map (
