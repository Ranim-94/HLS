...
//               /home/lenovo/Simulation_Linux/HLS/Parallel_Serial_Sys_Vivado/Parallel_Serial_Sys_Vivado.gen/sources_1/bd/paralle_serial_sys/ip/paralle_serial_sys_serial2parallel_0_0/paralle_serial_sys_serial2parallel_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "paralle_serial_sys_serial2parallel_0_0,serial2parallel,{}" *) (* CORE_GENERATION_INFO = "paralle_serial_sys_serial2parallel_0_0,serial2parallel,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=serial2parallel,x_ipVersion=1.0,x_ipCoreRevision=2114500282,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "serial2parallel,Vivado 2025.1" *) (* hls_module = "yes" *) 
module paralle_serial_sys_serial2parallel_0_0(ap_clk, ap_rst, d, serial_start, a, end_conversion)
/* synthesis syn_black_box black_box_pad_pin="ap_rst,d,serial_start,a[7:0],end_conversion" */
