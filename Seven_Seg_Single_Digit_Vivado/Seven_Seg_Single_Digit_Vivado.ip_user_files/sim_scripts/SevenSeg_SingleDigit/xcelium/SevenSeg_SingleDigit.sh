...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.SevenSeg_SingleDigit xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.SevenSeg_SingleDigit -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log SevenSeg_SingleDigit_sc.so .tmp_log xcelium_lib waves.shm c.obj)
