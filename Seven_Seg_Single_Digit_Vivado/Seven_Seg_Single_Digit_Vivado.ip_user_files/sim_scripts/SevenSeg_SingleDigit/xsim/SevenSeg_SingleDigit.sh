...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SevenSeg_SingleDigit xil_defaultlib.SevenSeg_SingleDigit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SevenSeg_SingleDigit -key {Behavioral:sim_1:Functional:SevenSeg_SingleDigit} -tclbatch cmd.tcl -protoinst "protoinst_files/SevenSeg_SingleDigit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SevenSeg_SingleDigit.wdb xsim.dir libdpi.so)
