...
#
# Script generated by Vivado on Thu Nov 27 09:40:59 CET 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SevenSeg_SingleDigit.sh
...
#
# Usage        : SevenSeg_SingleDigit.sh
#                SevenSeg_SingleDigit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SevenSeg_SingleDigit.sh [-reset_run]
#                SevenSeg_SingleDigit.sh [-reset_log]
#                SevenSeg_SingleDigit.sh [-help]
#
...
#                script (type 'SevenSeg_SingleDigit.sh -help' for more information).
#
...
# script info
echo -e "SevenSeg_SingleDigit.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SevenSeg_SingleDigit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SevenSeg_SingleDigit xil_defaultlib.glbl -o SevenSeg_SingleDigit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SevenSeg_SingleDigit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SevenSeg_SingleDigit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SevenSeg_SingleDigit_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SevenSeg_SingleDigit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SevenSeg_SingleDigit.sh [-help]\n\
Usage: SevenSeg_SingleDigit.sh [-step]\n\
Usage: SevenSeg_SingleDigit.sh [-lib_map_path]\n\
Usage: SevenSeg_SingleDigit.sh [-reset_run]\n\
Usage: SevenSeg_SingleDigit.sh [-reset_log]\n\
Usage: SevenSeg_SingleDigit.sh [-keep_index]\n\
Usage: SevenSeg_SingleDigit.sh [-noclean_files]\n\n\
