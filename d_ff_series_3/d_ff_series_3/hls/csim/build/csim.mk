...
HLS_SOURCES = ../../../../dffs-tb.cpp ../../../../main_dffs.cpp
...
$(ObjDir)/dffs-tb.o: ../../../../dffs-tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../dffs-tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/dffs-tb.d

$(ObjDir)/main_dffs.o: ../../../../main_dffs.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_dffs.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_dffs.d
