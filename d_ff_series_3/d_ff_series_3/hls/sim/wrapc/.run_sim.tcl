...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dffs_top.autotvin.dat"
	set constFileTvOut       "dffs_top.autotvout.dat"
	set constFileHdlTvIn     "dffs_top.autohdltvin.dat"
	set constFileHdlTvOut    "dffs_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
