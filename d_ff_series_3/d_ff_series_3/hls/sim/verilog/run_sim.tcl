...
if {[file isfile dffs_top.autotvin.dat]} {
	file delete -force dffs_top.autotvin.dat
}

if {[file isfile dffs_top.autotvout.dat]} {
	file delete -force dffs_top.autotvout.dat
}
