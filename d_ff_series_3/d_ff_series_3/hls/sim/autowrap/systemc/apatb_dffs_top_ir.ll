; ModuleID = '/home/lenovo/Simulation_Linux/HLS/d_ff_series_3/d_ff_series_3/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline willreturn
define void @apatb_dffs_top_ir(i1 zeroext %d, i1* noalias nocapture nonnull dereferenceable(1) %q1, i1* noalias nocapture nonnull dereferenceable(1) %q2, i1* noalias nocapture nonnull dereferenceable(1) %q3) local_unnamed_addr #0 {
entry:
  %q1_copy = alloca i1, align 512
  %q2_copy = alloca i1, align 512
  %q3_copy = alloca i1, align 512
  call fastcc void @copy_in(i1* nonnull %q1, i1* nonnull align 512 %q1_copy, i1* nonnull %q2, i1* nonnull align 512 %q2_copy, i1* nonnull %q3, i1* nonnull align 512 %q3_copy)
  call void @apatb_dffs_top_hw(i1 %d, i1* %q1_copy, i1* %q2_copy, i1* %q3_copy)
  call void @copy_back(i1* %q1, i1* %q1_copy, i1* %q2, i1* %q2_copy, i1* %q3, i1* %q3_copy)
  ret void
}
...
declare void @apatb_dffs_top_hw(i1, i1*, i1*, i1*)
...
declare void @dffs_top_hw_stub(i1 zeroext, i1* noalias nocapture nonnull, i1* noalias nocapture nonnull, i1* noalias nocapture nonnull)

define void @dffs_top_hw_stub_wrapper(i1, i1*, i1*, i1*) #4 {
entry:
  call void @copy_out(i1* null, i1* %1, i1* null, i1* %2, i1* null, i1* %3)
  call void @dffs_top_hw_stub(i1 %0, i1* %1, i1* %2, i1* %3)
