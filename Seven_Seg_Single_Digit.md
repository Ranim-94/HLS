...
## Project Overview
This project implements a single digit 7-segment display controller using Vitis HLS. The design takes a decimal digit (0-9) as input and outputs the corresponding 7-segment code along with control signals.
