...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LED_Controller xil_defaultlib.LED_Controller xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LED_Controller -key {Behavioral:sim_1:Functional:LED_Controller} -tclbatch cmd.tcl -protoinst "protoinst_files/LED_Controller.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LED_Controller.wdb xsim.dir libdpi.so)
