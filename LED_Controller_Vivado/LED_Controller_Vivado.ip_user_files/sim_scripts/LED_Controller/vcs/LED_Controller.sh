...
#
# Script generated by Vivado on Fri Oct 03 12:27:40 CEST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : LED_Controller.sh
...
#
# Usage        : LED_Controller.sh
#                LED_Controller.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                LED_Controller.sh [-reset_run]
#                LED_Controller.sh [-reset_log]
#                LED_Controller.sh [-help]
#
...
#                script (type 'LED_Controller.sh -help' for more information).
#
...
# script info
echo -e "LED_Controller.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./LED_Controller.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.LED_Controller xil_defaultlib.glbl -o LED_Controller_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./LED_Controller_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lenovo/Simulation_Linux/HLS/LED_Controller_Vivado/LED_Controller_Vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key LED_Controller_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc LED_Controller_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./LED_Controller.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: LED_Controller.sh [-help]\n\
Usage: LED_Controller.sh [-step]\n\
Usage: LED_Controller.sh [-lib_map_path]\n\
Usage: LED_Controller.sh [-reset_run]\n\
Usage: LED_Controller.sh [-reset_log]\n\
Usage: LED_Controller.sh [-keep_index]\n\
Usage: LED_Controller.sh [-noclean_files]\n\n\
