...
__attribute__((sdx_kernel("combination_lock", 0))) void combination_lock(ap_uint<4> x,
  bool enter,
  bool lock,
  bool &door_open,
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=combination_lock
# 66 "top_comb_lock.cpp"
