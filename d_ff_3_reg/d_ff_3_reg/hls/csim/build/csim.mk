...
HLS_SOURCES = ../../../../dff_reg-tb.cpp ../../../../main_dff_reg.cpp
...
$(ObjDir)/dff_reg-tb.o: ../../../../dff_reg-tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../dff_reg-tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/dff_reg-tb.d

$(ObjDir)/main_dff_reg.o: ../../../../main_dff_reg.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_dff_reg.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_dff_reg.d
