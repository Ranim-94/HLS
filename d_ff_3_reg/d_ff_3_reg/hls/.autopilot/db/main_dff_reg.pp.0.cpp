...
# 5 "./dff_reg.hpp" 2
# 4 "main_dff_reg.cpp" 2


__attribute__((sdx_kernel("dff_reg_top", 0))) void dff_reg_top(bool d,ap_uint<3>& q){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=dff_reg_top
# 6 "main_dff_reg.cpp"
