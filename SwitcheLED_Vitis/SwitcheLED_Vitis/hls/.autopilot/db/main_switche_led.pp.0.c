...
# 2 "<built-in>" 2
# 1 "main_switche_led.c" 2



__attribute__((sdx_kernel("led_via_switche", 0))) void led_via_switche(unsigned char switche_state,
                     unsigned char *led){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=led_via_switche
# 5 "main_switche_led.c"




#pragma HLS INTERFACE mode=ap_none port=switche_state
