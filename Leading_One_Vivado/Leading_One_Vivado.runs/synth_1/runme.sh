...
HD_PWD='/home/lenovo/Simulation_Linux/HLS/Leading_One_Vivado/Leading_One_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log leading_one_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source leading_one_wrapper.tcl
