...
#
# Script generated by Vivado on Sun Nov 16 16:35:14 CET 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : leading_one.sh
...
#
# Usage        : leading_one.sh
#                leading_one.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                leading_one.sh [-reset_run]
#                leading_one.sh [-reset_log]
#                leading_one.sh [-help]
#
...
#                script (type 'leading_one.sh -help' for more information).
#
...
# script info
echo -e "leading_one.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./leading_one.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.leading_one xil_defaultlib.glbl -o leading_one_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./leading_one_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key leading_one_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc leading_one_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./leading_one.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: leading_one.sh [-help]\n\
Usage: leading_one.sh [-step]\n\
Usage: leading_one.sh [-lib_map_path]\n\
Usage: leading_one.sh [-reset_run]\n\
Usage: leading_one.sh [-reset_log]\n\
Usage: leading_one.sh [-keep_index]\n\
Usage: leading_one.sh [-noclean_files]\n\n\
