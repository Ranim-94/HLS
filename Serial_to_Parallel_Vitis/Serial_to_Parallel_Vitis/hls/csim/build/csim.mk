...
HLS_SOURCES = ../../../../serial2parallel-tb.cpp ../../../../main_serial2parallel.cpp
...
$(ObjDir)/serial2parallel-tb.o: ../../../../serial2parallel-tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../serial2parallel-tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/serial2parallel-tb.d

$(ObjDir)/main_serial2parallel.o: ../../../../main_serial2parallel.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_serial2parallel.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_serial2parallel.d
