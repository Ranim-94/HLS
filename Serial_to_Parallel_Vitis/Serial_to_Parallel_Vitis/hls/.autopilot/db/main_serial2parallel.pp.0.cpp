...
# 2 "<built-in>" 2
# 1 "main_serial2parallel.cpp" 2

# 1 "./serial2parallel.hpp" 1
...
# 6 "./serial2parallel.hpp" 2
# 3 "main_serial2parallel.cpp" 2

__attribute__((sdx_kernel("serial2parallel", 0))) void serial2parallel(bool d, bool serial_start,
      ap_uint<8> &a, bool &end_conversion){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=serial2parallel
# 5 "main_serial2parallel.cpp"

# 18 "main_serial2parallel.cpp"
...
#pragma HLS INTERFACE ap_ctrl_none port=return
 ...
 ap_uint<8> next_state = state_reg;
 ...
 if (next_counter < 8 -1) {
  ...
  next_state = (next_state >> 1) | (d, (ap_uint<8 -1>)0);

  next_counter++;

  end_conversion = 0;

 } else if (next_counter == 8 -1) {
