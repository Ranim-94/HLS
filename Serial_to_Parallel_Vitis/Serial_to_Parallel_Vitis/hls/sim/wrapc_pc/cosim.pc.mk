...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /opt/Xilinx/2025.1/Vitis/lnx64/tools/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/opt/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/serial2parallel-tb.cpp_pre.cpp.tb.o : serial2parallel-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling serial2parallel-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/main_serial2parallel.cpp_pre.cpp.tb.o : main_serial2parallel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling main_serial2parallel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
