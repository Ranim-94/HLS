...
if {[file isfile serial2parallel.autotvin.dat]} {
	file delete -force serial2parallel.autotvin.dat
}

if {[file isfile serial2parallel.autotvout.dat]} {
	file delete -force serial2parallel.autotvout.dat
}
