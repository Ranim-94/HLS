...
`ifndef SERIAL2PARALLEL_REFERENCE_MODEL_SV
`define SERIAL2PARALLEL_REFERENCE_MODEL_SV

class serial2parallel_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(serial2parallel_reference_model)
