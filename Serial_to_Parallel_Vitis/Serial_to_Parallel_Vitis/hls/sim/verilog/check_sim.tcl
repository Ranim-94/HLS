...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.serial2parallel.autotvin_d.dat"
         "c.serial2parallel.autotvin_serial_start.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.serial2parallel.autotvout_a.dat"
         "rtl.serial2parallel.autotvout_end_conversion.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
