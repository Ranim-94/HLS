...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.parallel2serial.autotvin_a.dat"
         "c.parallel2serial.autotvin_begin_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.parallel2serial.autotvout_d.dat"
         "rtl.parallel2serial.autotvout_serial_start.dat"
         "rtl.parallel2serial.autotvout_serial_end.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
