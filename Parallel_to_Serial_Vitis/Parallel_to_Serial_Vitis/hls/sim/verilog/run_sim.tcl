...
if {[file isfile parallel2serial.autotvin.dat]} {
	file delete -force parallel2serial.autotvin.dat
}

if {[file isfile parallel2serial.autotvout.dat]} {
	file delete -force parallel2serial.autotvout.dat
}
