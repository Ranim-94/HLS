...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "parallel2serial.autotvin.dat"
	set constFileTvOut       "parallel2serial.autotvout.dat"
	set constFileHdlTvIn     "parallel2serial.autohdltvin.dat"
	set constFileHdlTvOut    "parallel2serial.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
