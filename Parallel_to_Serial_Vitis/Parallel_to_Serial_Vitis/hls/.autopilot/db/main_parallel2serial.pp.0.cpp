...
# 2 "<built-in>" 2
# 1 "main_parallel2serial.cpp" 2

# 1 "./parallel2serial.hpp" 1
...
# 5 "./parallel2serial.hpp" 2
# 3 "main_parallel2serial.cpp" 2


__attribute__((sdx_kernel("parallel2serial", 0))) void parallel2serial(
  ap_uint<8> a, bool begin,
  bool &d, bool &serial_start,bool &serial_end) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=parallel2serial
# 7 "main_parallel2serial.cpp"
