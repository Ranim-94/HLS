...
# 263 "/opt/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "main_comb_circuit.c" 2


# 1 "/opt/Xilinx/2025.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdbool.h" 1 3
# 4 "main_comb_circuit.c" 2

__attribute__((sdx_kernel("dummy_comb_circuit", 0))) void dummy_comb_circuit(_Bool a,_Bool b,_Bool c,_Bool *d){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=dummy_comb_circuit
# 5 "main_comb_circuit.c"
