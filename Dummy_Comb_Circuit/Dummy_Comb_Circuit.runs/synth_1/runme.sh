...
HD_PWD='/home/lenovo/Simulation_Linux/HLS/Dummy_Comb_Circuit/Dummy_Comb_Circuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comb_circuit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comb_circuit_wrapper.tcl
