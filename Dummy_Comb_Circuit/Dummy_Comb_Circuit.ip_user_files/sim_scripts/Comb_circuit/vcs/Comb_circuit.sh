...
#
# Script generated by Vivado on Thu Oct 16 10:12:26 CEST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Comb_circuit.sh
...
#
# Usage        : Comb_circuit.sh
#                Comb_circuit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Comb_circuit.sh [-reset_run]
#                Comb_circuit.sh [-reset_log]
#                Comb_circuit.sh [-help]
#
...
#                script (type 'Comb_circuit.sh -help' for more information).
#
...
# script info
echo -e "Comb_circuit.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Comb_circuit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Comb_circuit xil_defaultlib.glbl -o Comb_circuit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Comb_circuit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Comb_circuit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Comb_circuit_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Comb_circuit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Comb_circuit.sh [-help]\n\
Usage: Comb_circuit.sh [-step]\n\
Usage: Comb_circuit.sh [-lib_map_path]\n\
Usage: Comb_circuit.sh [-reset_run]\n\
Usage: Comb_circuit.sh [-reset_log]\n\
Usage: Comb_circuit.sh [-keep_index]\n\
Usage: Comb_circuit.sh [-noclean_files]\n\n\
