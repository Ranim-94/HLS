...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Comb_circuit xil_defaultlib.Comb_circuit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Comb_circuit -key {Behavioral:sim_1:Functional:Comb_circuit} -tclbatch cmd.tcl -protoinst "protoinst_files/Comb_circuit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Comb_circuit.wdb xsim.dir libdpi.so)
